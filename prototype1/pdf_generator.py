...
class PDFReportGenerator:
    ...
    def generate_report(self, output_path=None):
        ...
        if output_path is None:
            ...
            output_path = Path('reports') / f'university_analytics_report_{datetime.now().strftime("%Y%m%d_%H%M%S")}.pdf'
        ...
        story.append(Paragraph(f"Report Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}", 
                              styles['Normal']))
        story.append(Paragraph("Data Engineering System - Uganda Christian University", 
                              styles['Normal']))
